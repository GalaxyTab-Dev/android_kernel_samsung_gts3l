...
#if defined(CONFIG_MACH_GTS3LLTE_USA)
#include <linux/ccic/BOOT_FLASH_FW_BOOT5.h>
#include <linux/ccic/BOOT_FLASH_FW_BOOT6.h>
#else
#include <linux/ccic/BOOT_FLASH_FW_BOOT5_GTS3LEUR.h>
#include <linux/ccic/BOOT_FLASH_FW_BOOT6_GTS3LEUR.h>
#endif
...
#define VALID_FW_BOOT_VERSION(fw_boot) ((fw_boot == 0x5)||(fw_boot == 0x6))
